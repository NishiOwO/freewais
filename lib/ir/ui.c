/*                               -*- Mode: C -*- 
 * $Basename: ui.c $
 * $Revision: 1.5.1.5.1.3 $
 * Author          : Brewster Kahle, Jonny Goldman
 * Created On      : 92/02/12  13:53:41
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Mon May  5 10:52:10 1997
 * Language        : C
 * Update Count    : 1
...
#ifndef lint
static char *PRCSid = "$Id: ui.c 1.5.1.5.1.3 Mon, 05 May 1997 11:54:27 +0200 pfeifer $";
#endif
