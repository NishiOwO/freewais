/*                               -*- Mode: C -*- 
 * $Basename: server-single.c $
 * $Revision: 1.14.1.3 $
 * Author          : Harry Morris, morris@think.com
 * Created On      : Mon May  5 11:08:01 1997
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Mon May  5 11:09:38 1997
 * Language        : C
 * Update Count    : 1
...
#ifndef lint
static char *PRCSid = "$Id: server-single.c 1.14.1.3 Mon, 05 May 1997 11:54:27 +0200 pfeifer $";
#endif
