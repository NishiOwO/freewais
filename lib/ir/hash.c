/*                               -*- Mode: C -*- 
 * $Basename: hash.c $
 * $Revision: 1.4.1.7.1.3 $
 * Author          : Brewster Kahle
 * Created On      : 92/02/12  13:20:08
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Mon May  5 11:35:04 1997
 * Language        : C
 * Update Count    : 1
...
#ifndef lint
static char *PRCSid = "$Id: hash.c 1.4.1.7.1.3 Mon, 05 May 1997 11:54:27 +0200 pfeifer $";
#endif
...
static int hash_entry_compare _AP((const void *i,const void *j));

static int hash_entry_compare(i,j)
const void *i;
const void *j;
{
  return(strcmp(((hash_entry *)i)->key, ((hash_entry *)j)->key));
}
...
static int hash_entry_numeric_compare _AP((const void *i,const void *j));
...
const void *j;
{
  int i_sign = 1;
  int j_sign = 1;
  char* i_key = ((hash_entry *)i)->key;
  char* j_key = ((hash_entry *)j)->key;
