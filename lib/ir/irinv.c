/*                               -*- Mode: C -*- 
 * $Basename: irinv.c $
 * $Revision: 1.6.1.6.1.4 $
 * Author          : Brewster@think.com
 * Created On      : 92/03/01  16:11:16
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Mon May  5 11:27:54 1997
 * Language        : C
 * Update Count    : 11
...

  {
    ...
    while (true) {
      ...
      if (db->fields[field_id].numeric)
        compare= atoi(input_word_1)-atoi(input_word_2); /* >0 if 1 
                                                          is bigger */
      else
        compare= strcmp (input_word_1, input_word_2);   /* +1 if 1 
                                                          is bigger */
