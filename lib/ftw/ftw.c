/*                               -*- Mode: C -*- 
 * $Basename: ftw.c $
 * $Revision: 1.3.1.3.1.3 $
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Tue May  6 09:51:14 1997
 * Language        : C
 * Update Count    : 2
...
#ifdef	RCSID
static char RCS[] = "$Header: /home/cvs/freeWAIS-sf/lib/ftw.c,v 2.4 1997/04/24 13:56:24 pfeifer Exp $";
#endif	/* RCSID */
