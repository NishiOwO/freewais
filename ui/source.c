/*                               -*- Mode: C -*- 
 * $Basename: source.c $
 * $Revision: 1.7.1.5.1.4 $
 * Author          : jonathan@Think.COM
 * Created On      : 92/03/01  13:07:25
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Wed May  7 15:33:38 1997
 * Language        : C
 * Update Count    : 2
...
#ifndef lint
static char *PRCSid = "$Id: source.c 1.7.1.5.1.4 Wed, 07 May 1997 18:04:42 +0200 pfeifer $";
#endif
