/*                               -*- Mode: C -*- 
 * $Basename: waissearch.c $
 * $Revision: 1.7.1.7.1.3 $
 * Author          : Brewster@think.com
 * Created On      : 92/02/16  12:13:36
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Mon May  5 10:02:21 1997
 * Language        : C
 * Update Count    : 1
...
#ifndef lint
static char *PRCSid = "$Id: waissearch.c 1.7.1.7.1.3 Mon, 05 May 1997 11:54:27 +0200 pfeifer $";
#endif
