/*                               -*- Mode: C -*- 
 * $Basename: document.c $
 * $Revision: 1.6.1.7.1.3 $
 * Author          : jonathan@Think.COM
 * Created On      : 92/03/08  09:13:13
 * Last Modified By: Ulrich Pfeifer
 * Last Modified On: Mon May  5 10:22:22 1997
 * Language        : C
 * Update Count    : 1
...
#ifndef lint
static char *PRCSid = "$Id: document.c 1.6.1.7.1.3 Mon, 05 May 1997 11:54:27 +0200 pfeifer $";
#endif
